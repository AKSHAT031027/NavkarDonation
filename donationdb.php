            ...
            <form action="save.php" method="post">
                <div class="container mt-1 border">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control initial-scale" name ="fullname" id="" placeholder="Enter Name"
                            required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" class="form-control initial-scale"  name ="email" id=""placeholder="" required>

                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="phone" class="form-label">Phone *</label>
                            <input type="tel" class="form-control initial-scale" name ="phone" id="" placeholder="91+" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control initial-scale" name = "dob"  id="" required>

                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="gender" class="form-label">Gender *</label>
                            <select class="form-control initial-scale" name = "gender"  id="" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control initial-scale" name = "fname" id=""
                                placeholder="Enter father's Name" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="phone" class="form-label">Father's Contact No. *</label>
                            <input type="tel" class="form-control initial-scale" name = "fphone" id="" placeholder="91+" required>
...
<div>
    Privacy Policy: We respect your privacy and are committed to protecting your personal information. When you make a donation, we collect basic details like your name, email, and payment information solely to process your donation and send receipts or updates. Your data is securely handled and never sold or shared, except with trusted payment processors or if required by law.
                    ...
                    <br>
                    <h6 class="text-center">Thank you for your donation❤</h6>
            </form>
        </div>
    </div>
    </div>
